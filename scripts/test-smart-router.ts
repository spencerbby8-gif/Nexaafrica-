...
if (decision) {
  ...
  console.log(`Factors:`)
  console.log(`  • Measured health: ${decision.factors.measuredHealth}/30`)
  console.log(`  • Latency: ${decision.factors.latencyScore}/20`)
  console.log(`  • Task fit (measured): ${decision.factors.taskFit}/20`)
  console.log(`  • Cost: ${decision.factors.costScore}/10`)
  console.log(`  • Exploration: ${decision.factors.explorationBonus}/10`)
  console.log(`  • Recency: ${decision.factors.recencyScore}/7`)
  console.log(`  • Config tie-break: ${decision.factors.configTieBreak}/3`)
